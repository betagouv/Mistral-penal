...
(function() {
    ...
    const autoSaveAddEvent = new Event('autoSaveAddNote', {
        bubbles: true,
        cancelable: true,
        composed: false
    })
    ...
    CKEDITOR.plugins.add("autosave",
        {
            ...
            init: function(editor) {
                ...
                const affaireId = document.getElementById('note_audience_add_affaireId').value;
                ...
                var defaultConfig = {
                    ...
                    SaveKeyIgnoreParams: "",
                    SaveKey: 'autosave_note_audience_' + affaireId,
                    NotOlderThen : 1440*30,
                    saveOnDestroy : false,
                ...
                editor.on("uiSpace",
                    function(event) {
                        ...
                        event.data.html +="<div id='synchro_server' unselectable='on'></div>";
                        }
                    }
                );
                editor.on("key",
    ...
    function SaveData(autoSaveKey, editorInstance, config) {
        ...
        document.querySelector("#note_audience_add_note").dispatchEvent(autoSaveAddEvent);
